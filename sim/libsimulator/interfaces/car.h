...
typedef struct  CarPenalty
{
    ...
    struct {
        struct CarPenalty *tqe_next;	/* next element */				\
        struct CarPenalty **tqe_prev;	/* address of previous next element */	\
    } link;
} tCarPenalty;

typedef struct CarPenaltyHead {
        struct CarPenalty *tqh_first;	/* next element */				\
        struct CarPenalty **tqh_last;	/* address of previous next element */	\
} tCarPenaltyHead;
...
typedef struct  {
    tdble   zRoad;      /**< road height bellow the wheel */
...
typedef struct  {
    GfParmHandle *paramsHandle;	/**< accessible parameters for modules */
    GfParmHandle *carHandle;	/**< parameters for car caracteristics */
