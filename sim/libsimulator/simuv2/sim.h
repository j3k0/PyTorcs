...
extern "C" void SimUpdate(tSituation*, double deltaTime, int telemetry);
extern "C" void SimInit(int nbcars);
extern "C" void SimShutdown(void);
...
extern void SimSuspConfig(GfParmHandle *hdle, char *section, tSuspension *susp, tdble F0, tdble X0);
...
extern void SimBrakeConfig(GfParmHandle *hdle, char *section, tBrake *brake);
...
extern void SimDifferentialConfig(GfParmHandle *hdle, char *section, tDifferential *differential);
