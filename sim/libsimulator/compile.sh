...
# gcc -arch i386 -fpic -I../libsimulator/interfaces -I../libsimulator -I.. -c $SRCDIR/$i 2> /dev/null
	gcc $PYTHON_FLAGS -fpic -I../libsimulator/interfaces -I../libsimulator -I.. -c $SRCDIR/$i 2> /dev/null
done

for i in $CPP_SOURCES
do
	echo "C $i"
	g++ $PYTHON_FLAGS -fpic -I../libsimulator/interfaces -I../libsimulator -I.. -c $SRCDIR/$i 2> /dev/null
done
